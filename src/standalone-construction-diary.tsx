...
export default function StandaloneConstructionDiaryDebug() {
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Bautagebuch Debug (Standalone)</h1>
        ...
        <div className="flex gap-4">
          ...
          <a href="/construction-diary-debug" className="no-underline">
            <Button variant="outline">Standard Bautagebuch Debug</Button>
          </a>
        </div>
      </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="col-span-2">
                          ...
                          <FormControl>
                            <Input placeholder="Beschreibung der Tätigkeit" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="col-span-2">
                          ...
                          <FormControl>
                            <Textarea 
                              placeholder="Verwendete Materialien und Mengen (optional)" 
                              {...field}
                              value={field.value || ''}
                            />
                          </FormControl>
                      ...
                      render={({ field }) => (
                        <FormItem className="col-span-2">
                          ...
                          <FormControl>
                            ...
                            >
                              <SelectTrigger>
                                <SelectValue placeholder="Vorfallstyp auswählen" />
                              </SelectTrigger>
                              <SelectContent>
                          ...
                          <FormDescription>
                            Wählen Sie einen Vorfallstyp, falls zutreffend.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
          ...
          <CardContent className="py-5">
            {isLoading ? (
              <div className="flex items-center justify-center p-6">
                ...
                <span className="ml-2">Einträge werden geladen...</span>
              </div>
            ) : error ? (
              ...
              <div className="flex flex-col items-center justify-center p-10 text-center">
                ...
                <h3 className="text-lg font-medium mb-2">Keine Einträge vorhanden</h3>
                  ...
                  <TableBody>
                    {diaryEntries.map((entry) => (
                      <TableRow key={entry.id}>
                        ...
                        <TableCell className="max-w-[200px] truncate" title={entry.activity}>
                          {entry.activity}
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          {renderIncidentBadge(entry.incidentType)}
                        </TableCell>
